...
class NewBudget extends Component{
    constructor(props){
      ...
      this.state = {
        budget_name: this.props.navigation.state.params.budget_name,
        monthly_spend: this.props.navigation.state.params.monthly_spend.toString(),
        errors: []
      };
    ...
    async handleSubmit(){
      ...
      try {
        let response = await fetch('https://budgetguru.herokuapp.com/budgets/update/'+global.ACCESS_TOKEN, {
                              method: 'POST',
                              headers: {
      ...
      const budget = this.props.navigation.state.params
        return(
            <ScrollView style={{ backgroundColor: colors.background }}>
              ...
              />
              <TextInput
                value={this.state.monthly_spend}
